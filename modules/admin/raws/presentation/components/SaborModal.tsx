"use client";
// src/features/coberturas/presentation/components/SaborModal.tsx
...
interface Props {
  ...
  sabor?: Sabor | null;
  onClose: () => void;
  onSave: (dto: CreateSaborDTO) => Promise<void>;
}

export function SaborModal({ open, sabor, onClose, onSave }: Props) {
