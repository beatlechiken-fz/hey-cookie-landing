"use client";
// src/features/coberturas/presentation/components/CoberturaModal.tsx
...
interface Props {
  ...
  onClose: () => void;
  onSave: (dto: CreateCoberturaDTO) => Promise<void>;
  onUploadImage: (file: File) => Promise<string>;
}

interface LineItem extends CreateCoberturaIngredienteDTO {
  _nombre: string;
  _unidad: string;
  _costoUnidad: number;
}

export function CoberturaModal({ open, cobertura, onClose, onSave, onUploadImage }: Props) {
  const isEdit = Boolean(cobertura);
  ...
  const costoTotal = lineas.reduce(
    (sum, l) => sum + l.cantidad * l._costoUnidad,
    0,
  );
  ...
  useEffect(() => {
    if (!open) return;
    if (cobertura) {
      setNombre(cobertura.nombre);
      setDescripcion(cobertura.descripcion ?? "");
      setElaboracion(cobertura.elaboracion ?? "");
      setImagenUrl(cobertura.imagenUrl ?? null);
      setLineas(
        cobertura.ingredientes.map((i) => ({
              ...
              >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                      <input
                        ...
                        className="hidden"
                        id="cobertura-image-upload"
                      />
                      <label
                        htmlFor="cobertura-image-upload"
                        className={
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    placeholder="Ej: Buttercream queso crema"
                    autoFocus
                  />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    placeholder="Describe las notas, textura y usos de esta cobertura…"
                  />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    placeholder="Describe paso a paso cómo elaborar esta cobertura…"
                  />
                </div>
                ...
                <div className="flex items-start gap-2 px-3 py-2.5 rounded-xl bg-amber-50 border border-amber-200">
                  ...
                  <p className="text-[12px] text-amber-800 leading-relaxed">
                    Las cantidades ingresadas están basadas en un{" "}
                    <strong>molde de 24 cm de diámetro</strong>.
                  </p>
                </div>
