...
interface LineItem extends CreateJarabeIngredienteDTO {
  _nombre: string;
  _unidad: string;
  _costoUnidad: number;
}
              ...
              >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    placeholder="Describe las notas y usos de este jarabe…"
                  />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    placeholder="Describe paso a paso cómo elaborar este jarabe…"
                  />
                </div>
                ...
                <div className="flex items-start gap-2 px-3 py-2.5 rounded-xl bg-amber-50 border border-amber-200">
                  ...
                  <p className="text-[12px] text-amber-800 leading-relaxed">
                    ...
                    <strong>molde de 22 cm de diámetro</strong>.
                  </p>
                </div>
